...
(function () {
    ...
    var g, k, l = (new Date).getTime() + "-" + Math.floor(1001 * Math.random() + 0);
    ...
    g.m = function () {
        if (this.b) return this.b ? aa(this.src) : void 0
    };
    g.toString = function () {
        var a = "";
    ...
    var ba, q, r, t, u, v, w, ca, x, da, y, B, C, D, E, F, G, fa, ia, H, I, J, ja, ka, K, la, L, ma, M, N;
    ba = p("log_level", 0);
    q = p("java_applet_enabled", !1);
    r = !1;
    t = p("scan_app_enabled", !0);
    u = p("scan_app_download_url", "http://asprise.azureedge.net/scanapp/scan-setup.exe");
    v = p("scan_app_min_version", "2.04");
    w = p("license", "");
    ca = p("skip_load_default_css", !1);
    x = p("scan_app_port_range_lowest", 9713);
    da = p("scan_app_port_range_highest", 9716);
    D = C = B = y = void 0;
    E = [];
    G = F = void 0;
    fa = p("form_field_name_for_img_objects", "com_asprise_scannerjs_images[]");
    ia = p("form_field_name_for_img_urls", "com_asprise_scannerjs_images_urls[]");
    H = !1;
    I = p("eager_init", !0);
    J = null;
    ja = p("display_install_func", void 0);
    ka = p("display_scan_ready_func", void 0);
    K = p("event_listener", void 0);
    la = p("sys_response_callback_func", void 0);
    L = !1;
    ma = p("additional_css_classes_for_dialogs", "");
    M = p("file_name_base", "scanner");
    N = function () {
        if (!H) {
            J = new Date;
            K && K("pre-init");
            p("skip_fix_formdata_append", !1) || na();
            O("Initializing Scanner.js v2.10.3 \u00a9 Asprise ...");
            ca || oa();
            if (q && P()) {
                var a = window.location.href;
                a && 0 > a.toLowerCase().indexOf("http:") && 0 > a.toLowerCase().indexOf("https:") && (O("The scan applet does *NOT* work in local HTML files. Please host this page on localhost or any other servers and access it using http:// or https://.", !0), alert("The scan applet does *NOT* work in local HTML files. Please host this page on localhost or any other servers and access it using http:// or https://."));
                ...
                t && R() && (!ra() || Q.firefox ? window.setTimeout(function () {
                    L || (O("Java applet doesn't seem running. Falling back to scan app ..."), S())
                }, 1E3) : O("JRE: " + ta.getJREs()))
            } else q && !P() && O("The scanning Java applet is set to on, but this browser doesn't support NPAPI: " + Q.name + " " + Q.version, !0), S();
    ...
    function U(a, b, c, d, f, e, h, n, z, ea) {
        V() || r || "scan" != b && "listSources" != b && "getSource" != b && "getSystemInfo" != b || (T = arguments);
        if (!V() && !r) return q && P() ? null != J && 1E4 < (new Date).getTime() - J.getTime() && ua(!0) : ua(!0), !1;
        ...
        if ("PENDING" == D || "PROCESSING" == D) return W("You can not submit a new request as the previous request has not completed yet."), !1;
        ...
        for (var A = {
            ...
            pageLoadId: va()
        }, sa = [], ha = 2; ha < arguments.length; ha++) sa.push(arguments[ha]);
        A.funcArgs = sa;
        A = JSON.stringify(A);
        D = "PENDING";
        F = A;
    ...
    function xa(a) {
        ...
        if (a && 7 < a.length && "SYSTEM/" == a.substr(0, 7)) try {
            ...
            if (0 < c && "NET" == a.substr(7, 3)) {
                var d = a.substr(0, c);
                ya(a.substr(c + 1).trim().split("|"), function (a, b) {
                    try {
                        B.send(d + ":" + JSON.stringify({
                            success: a,
                            data: b
                        }))
                    } catch (h) {
                        O("Failed to send command: " + h, !0)
                    }
                })
            } else la && (0 < c ? la(a.substr(0, c), a.substr(c + 1)) : W("Invalid system response: " + a))
        } catch (f) {
            O("Error while processing system request: " + f, !0)
        } else {
            try {
                b = JSON.parse(a)
            } catch (f) {
    ...
    function X(a, b, c, d, f, e, h) {
        ...
        if (K) try {
            ...
            O("Exception occurred in event handler: " + n, !0)
        }
        try {
            window.focus()
        } catch (n) { }
    ...
    function Aa(a) {
        L = !0;
        if ("PENDING" == D || "PROCESSING" == D) {
            var b = JSON.parse(F);
            E.push(b);
            O("Canceled func call: " + b.funcName + ", call id: " + b.funcCallId);
            K && K("func-cancelled", b)
        }
        D = void 0;
        ua(!1);
        "function" == typeof ka && ka();
        K && K("ready", a);
    ...
    function Ba(a) {
        B = a;
        O("Scan WebSocket server connected: " + B.url);
        Aa(!0);
        w && a.send("LICENSE: " + w);
        v && a.send("MIN_VERSION: " + v);
        wa()
    }
    ...
    function S(a) {
        if (t)
            if (B) C = void 0, B.close();
            else {
                a || (y = void 0);
                var b = null != window.location.href && "http:" == window.location.href.substr(0, 5) ? "ws://127.0.0.1" : "wss://local.scannerjs.com";
                a = 3 < b.length && "wss" == b.substr(0, 3).toLowerCase();
                void 0 == y ? y = x : void 0 != C && 1E4 > (new Date).getTime() - C && (y += 1);
                y % 2 != (a ? 0 : 1) && (y += 1);
                if (y < x || y > da) O("Failed to connect to WebSocket server.", !0), K && K("failed-to-connect"), P(), S();
                else {
                    C = (new Date).getTime();
                    a = Da;
                    b = b + ":" + y + "/" + va() + "/";
    ...
    function qa() {
        var a;
        (a = Ea()) || (a = "https://asprise.azureedge.net/scannerjs/"); - 1 < a.indexOf("FORCE_REFRESH") && -1 < window.location.href.indexOf("FORCE_REFRESH") && (a = a.replace(/FORCE_REFRESH/g, "FORCE_REFRESH_" + (new Date).getTime()));
        var b = document.getElementById("com_asprise_scan_applet");
        null == b && (b = ta.versionCheck("1.7.0_45+") ? "asprise_scan.jar" : "asprise_scan-legacy.jar", b = Y({
            name: "applet",
            attributes: {
    ...
    function ua(a) {
        if ("function" != typeof ja || ja(a)) H ? Fa(a) : (N(), a || Fa(a))
    }
            ...
            if (!b) {
                b = {
                    ...
                    attributes: {
                        ...
                        "class": "asprise-web-scan-dialog-wrapper " + ma
                    },
                    children: [{
                        name: "div",
                        attributes: {
                        ...
                        children: [{
                            ...
                            children: [{
                                name: "h2",
                                attributes: {
                                    text: "Завершите однократную настройку"
                                }
                            }, {
                                name: "table",
                                attributes: {
                                ...
                                children: [{
                                    ...
                                    children: [{
                                        ...
                                        children: [{
                                            ...
                                            children: [{
                                                ...
                                                attributes: {
                                                    ...
                                                    href: u,
                                                    target: "_blank",
                                                    title: "Исполняемый файл для одноразовой установки",
                                                    text: "Скачайте программу"
                                                }
                                            }, {
                                                name: "span",
                                                attributes: {
                                                ...
                                                attributes: {
                                                    style: "font-size: smaller",
                                                    "class": "underline",
                                                    href: u.substr(0, u.lastIndexOf(".")) + ".zip",
                                                    target: "_blank",
                                                    title: "Zip формат",
                                                    text: "zip"
                                                }
                                                ...
                                                attributes: {
                                                    style: "font-size: smaller",
                                                    "class": "underline",
                                                    href: u.substr(0, u.lastIndexOf(".")) + ".7z",
                                                    target: "_blank",
                                                    title: "7Z формат",
                                                    text: "7z"
                                                }
                                        ...
                                        children: [{
                                            ...
                                            name: "p",
                                            attributes: {
                                                text: "Запускаем установку, следуем инструкции;"
                                            }
                                        }]
                                    }, {
                                        name: "td",
                                ...
                                children: [{
                                    name: "span",
                                    attributes: {
                                        text: "Приложение для сканирования уже настроено? "
                                    }
                                }, {
                                    name: "a",
                                    attributes: {
                                        ...
                                        target: "_top",
                                        text: "Нажмите здесь, чтобы включить."
                                    }
                                }]
                            }]
                        }]
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                children: [{
                                    name: "p",
                                    attributes: {
                                        text: "Все готово. Вы можете сканировать."
                                    }
                                }]
                            }]
                        }]
                ...
                if (null == c) {
                    W("please do not execute displaySetupDialog in <header>!");
                    return
                }
                c.appendChild(Y(b));
    ...
    function oa() {
        for (var a = !1, b = document.getElementsByTagName("link"), c = 0; c < b.length; c++) {
            var d = b.item(c),
                f = new RegExp(M + "\\.css(\\?\\w*)?$");
            d.href && d.href.match(f) && (a = !0)
        }
        a || (a = Ea() + M + ".css", b = document.createElement("link"), b.setAttribute("rel", "stylesheet"), b.setAttribute("type", "text/css"), b.setAttribute("href", a), document.getElementsByTagName("head")[0].appendChild(b))
    }
    ...
    function ya(a, b) {
        ...
        if (0 == a.length) b(!1, null);
            ...
            d.onreadystatechange = function () {
                d.readyState === XMLHttpRequest.DONE && (200 <= d.status && 300 > d.status ? b(!0, d.responseText) : (O("Failed to " + c + ": " + d.statusText, !0), ya(a, b)))
            };
            d.send()
        }
    }
    ...
    function Da(a) {
        ...
        "function" === typeof Ba ? b.onopen = function () {
            Ba(b)
        } : (O("No onOpenFunc specified for " + a), b.onopen = function () {
            O("WebSocket [" + b.url + "] opens.")
        });
        "function" === typeof Ca ? b.onclose = function () {
            Ca()
        } : (O("No onCloseFunc specified for " + a), b.onclose = function (a) {
            O("WebSocket [" + b.url + "] closes: " + a.code + " / " + a.reason + " / clean? " + a.o)
        });
        "function" === typeof za ? (b.onmessage = function (a) {
            za(a)
        }, b.onerror = function (a) {
            O("WebSocket [" + b.url + "] error occurs:" + JSON.stringify(a))
        }, K && K("disconnected", !0)) : W("You must specify onMesgFunc for " + a)
    }
    ...
    function va() {
        window.sessionStorage && (sessionStorage.getItem("pageLoadId") ? l = sessionStorage.getItem("pageLoadId") : sessionStorage.setItem("pageLoadId", l));
        return l
    }
    ...
    function na() {
        k || (k = window.FormData.prototype.append, window.FormData.prototype.append = function (a, b, c) {
            b instanceof Blob && null == c ? k.apply(this, [a, b, b.name]) : k.apply(this, arguments)
        })
    }
    var ta = deployJava;
    ...
    window.scannerjs.getSource = function (a, b, c, d, f, e, h, n) {
        return U(a, "getSource", 2 <= arguments.length ? b : "select", 3 <= arguments.length ? c : !0, 4 <= arguments.length ? d : null, 5 <= arguments.length ? f : !0, 6 <= arguments.length ? e : !1, 7 <= arguments.length ? h : null, 8 <= arguments.length && null != n ? "string" === typeof n ? n : JSON.stringify(n) : "")
    };
    window.scannerjs.getSystemInfo = function (a) {
        return U(a, "asprise_scan_system_info")
    };
    window.scannerjs.initialize = N;
    window.scannerjs.getScannedImages = function (a, b, c) {
        ...
        if ("object" === typeof a && a.output instanceof Array)
            for (var f = a.output, e = 0; e < f.length; e++) {
                var h = f[e];
                if (b && "return-base64" == h.type || c && "return-base64-thumbnail" == h.type) {
                    var n = h.format;
                    n = null == n ? "application/octet-stream" : 0 <= n.toLowerCase().indexOf("bmp") ? "image/bmp" : 0 <= n.toLowerCase().indexOf("png") ? "image/png" : 0 <= n.toLowerCase().indexOf("jp") ? "image/jpeg" : 0 <= n.toLowerCase().indexOf("tif") ? "image/tiff" : 0 <= n.toLowerCase().indexOf("pdf") ? "application/pdf" : "application/octet-stream";
                    if ("application/octet-stream" == n) O("Unable to find mime type for " + h.format);
                    else if (h.result instanceof Array)
                        for (var z = 0; z < h.result.length; z++) {
                            var ea = a.images instanceof Array && z < a.images.length ? a.images[z] : null;
                            d.push(new m(n, !0, "data:" + n + ";base64," + h.result[z], ea ? ea.image_info : void 0, h.hasOwnProperty("selected_action") ? h.selected_action : void 0, h.hasOwnProperty("selected_filename") ? h.selected_filename : void 0))
    ...
    window.scannerjs.submitFormWithImages = function (a, b, c) {
        if (b instanceof Array && 0 != b.length) {
            ...
            if (null == e) W("Form doesn't exist: " + a);
                ...
                a = new FormData(e);
                for (d = 0; d < b.length; d++) f = b[d], f.b ? a.append(fa, aa(f.src, f.mimeType)) : a.append(ia, f.src);
                O("POST images, count: " + b.length);
                var h = new XMLHttpRequest;
                h.open("POST", e.getAttribute("action"), !0);
                h.onreadystatechange = function () {
                    "function" == typeof c && c(h)
                };
                h.send(a);
                O("Form posted: " + h);
                return h
    ...
    window.scannerjs.fadeOut = Ga;
    window.scannerjs.hasJava = ra;
    ...
    window.scannerjs.version = "2.10.3";
    ...
    window.scannerjs.isInitialized = H;
    window.scannerjs.isReady = L;
    window.scannerjs.isConnectedToScanWebSocket = V;
    window.scannerjs.ScannedImage = m;
    window.scannerjs.ScannedImage.prototype.mimeType = m.prototype.mimeType;
    window.scannerjs.ScannedImage.prototype.srcIsBase64 = m.prototype.b;
    window.scannerjs.ScannedImage.prototype.imageInfo = m.prototype.a;
    window.scannerjs.ScannedImage.prototype.getWidth = m.prototype.h;
    window.scannerjs.ScannedImage.prototype.getHeight = m.prototype.f;
    window.scannerjs.ScannedImage.prototype.isColor = m.prototype.j;
    window.scannerjs.ScannedImage.prototype.isGray = m.prototype.l;
    window.scannerjs.ScannedImage.prototype.isBlackWhite = m.prototype.i;
    window.scannerjs.ScannedImage.prototype.getResolution = m.prototype.g;
    window.scannerjs.ScannedImage.prototype.getBitsPerPixel = m.prototype.c;
    window.scannerjs.ScannedImage.prototype.getBase64NoPrefix = m.prototype.m;
    window.scannerjs.ScannedImage.prototype.toString = m.prototype.toString;
